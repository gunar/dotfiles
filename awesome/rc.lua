...
globalkeys = awful.util.table.join(globalkeys,
    ...
    awful.key({ modkey,           }, "b", function () awful.spawn("termite -e \"tmux new-session 'bc -l'\"") end),
    ...
    awful.key({ modkey, "Control", "Shift" }, "o", function () awful.spawn("chromium --disk-cache-dir=/tmp/cache --profile-directory=\"Profile 4\"") end),
    awful.key({ modkey, "Shift"   }, "o", function () awful.spawn("chromium --disk-cache-dir=/tmp/cache --profile-directory=Default --incognito") end),
