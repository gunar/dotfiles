...
beautiful.init("/home/gcg/.config/awesome/theme/theme.lua")
...
widgets = {kbdcfg.widget, w.textclock }

local divider_text = wibox.widget.textbox()
divider_text:set_markup("◢")
divider_text:set_font("sans 25")
local divider = wibox.widget.background()
divider:set_widget(divider_text)
divider:set_bg(theme.bg_normal)
divider:set_fg("#ffffff33")

local divider2 = wibox.widget.background()
divider2:set_widget(divider_text)
divider2:set_fg(theme.bg_normal)
divider2:set_bg("#ffffff33")
...
globalkeys = awful.util.table.join(
    ...
    -- awful.key({ "Control"        }, "q", function () awful.util.spawn("tracker-needle") end),
